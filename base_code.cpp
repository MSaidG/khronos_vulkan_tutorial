...
private:
  ...
  void createGraphicsPipeline() {
    ...
    pipelineCreateInfoChain.get<vk::GraphicsPipelineCreateInfo>().stageCount =
        2;
    pipelineCreateInfoChain.get<vk::GraphicsPipelineCreateInfo>().pStages =
        shaderStages;
    ...
    pipelineCreateInfoChain.get<vk::GraphicsPipelineCreateInfo>().layout =
        pipelineLayout;
